...
<body>
        ...
        <div class="col-lg-6 col-md-6">
          <nav class="header__menu mobile-menu">
            <ul>
              ...
              <li class="active"><a href="<?= base_url(); ?>contact">Kontak Kami</a></li>
            </ul>
          </nav>
        </div>
        <div class="col-lg-3 col-md-3">
  ...
  <!-- Map Begin -->
  <div class="map">
    <iframe src="<?= $data['maps']; ?>" height="500" style="border: 0" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
  </div>
  <!-- Map End -->
        ...
        <div class="col-lg-6 col-md-6">
          <div class="contact__text">
            <div class="section-title">
              ...
              <h2>Kontak Kami</h2>
              <div class="mt-3">
                <p><span class="text-dark"><i class="fa fa-facebook"></i>&emsp; : &ensp;<?= $data['facebook']; ?></span></p>
                <p><span class="text-dark"><i class="fa fa-envelope-o"></i>&emsp; : &ensp;<?= $data['email']; ?></span></p>
                <p><span class="text-dark"><i class="fa fa-whatsapp"></i>&emsp; : &ensp;<?= $data['whatsapp']; ?></span></p>
                <p><span class="text-dark"><i class="fa fa-instagram"></i>&emsp; : &ensp;<?= $data['instagram']; ?></span></p>
              </div>
            ...
            <ul>
              <li>
                <h4>Alamat Kami</h4>
                <p class="ck-content"><?= $data['alamat']; ?></p>
              </li>
            </ul>
          </div>
        </div>
        <div class="col-lg-6 col-md-6">
          <div class="contact__form">
            ...
            <form action="#">
              ...
              <div class="row mt-4">
                <div class="col-lg-6">
                  <input type="text" id="wa_nama" placeholder="Nama" />
                </div>
                <div class="col-lg-6">
                  <input type="text" id="wa_email" placeholder="Email" />
                </div>
                <div class="col-lg-12">
                  <textarea id="wa_pesan" placeholder="Pesan.."></textarea>
                  <!-- <button type="submit" class="site-btn btn_contact">Message</button> -->
                  <a class="primary-btn text-white btn_contact" type="submit">Message</a>
                </div>
              </div>
            </form>
          </div>
          ...
          <div class="footer__copyright__text">
            ...
            <p>
              ...
              <script>
               ...
               Copyright • All rights reserved • Made in Kebumen <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" target="_blank"> Ratih Souvenir Kebumen </a>
            </p>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
          </div>
        </div>
