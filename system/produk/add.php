...
<head>
    ...
    <title>Ratih Souvenir | Input Produk</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
                        ...
                        <div class="col">
                            <div class="card card-outline card-primary">
                                <div class="card-header">
                                    <h2 class="card-title mt-1"><strong>Input Produk</strong></h2>
                                ...
                                <form method="POST" action="<?= base_url('system/produk/function'); ?>" class="needs-validation" enctype="multipart/form-data" novalidate>
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="slug_produk" readonly>
                                            <small class="form-text text-secondary">Slug Produk merupakan nama produk yang sudah diubah agar lebih SEO Friendly</small>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Harga Produk (Rp)</label>
                                            <input type="number" class="form-control" name="harga_produk" placeholder="Masukan Harga" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" autocomplete="off" data-role="tagsinput" class="form-control" name="ukuran_produk" placeholder="Masukan Ukuran" required>
                                            <small class="form-text text-secondary">Untuk memasukan banyak ukuran tekan Spasi/Enter.</small>
                                            <div class="invalid-feedback">
                                                Harap ketik "Wajib_Pilih"
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Opsi 2</label>
                                            <input type="text" autocomplete="off" data-role="tagsinput" class="form-control" name="warna_produk" placeholder="Masukan Warna" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="kategori">
                                                ...
                                                while ($pecah = $ambil->fetch_assoc()) { ?>
                                                    <option value="<?= $pecah['nama_kategori']; ?>"><?= $pecah['nama_kategori']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        <div class="form-group mt-2">
                                            <img src="<?= base_url(); ?>assets/img/default.jpg" id="preview" class="border img-thumbnail" width="200" height="150">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputFile">Sampul Produk</label>
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input" name="foto" id="foto" accept="image/*">
                                                    <label class="custom-file-label filename_foto" for="exampleInputFile">Pilih Sampul</label>
                                                    <div class="invalid-feedback">
                                                        Harap masukan sampul
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control editor-berita1" name="isi_desc" required></textarea>
                                            <div class="invalid-feedback">
                                                Harap masukan deskripsi produk
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
                                    <div class="card-footer">
                                        <button type="submit" name="add_produk" class="btn btn-success btn-block">Submit</button>
                                    </div>
                                </form>
                                <!-- /.card-body -->
                            </div>
    ...
    <script>
        $("#nama_produk").keyup(function() {
            $("#slug_produk").val(convertToSlug($("#nama_produk").val()));
        });
